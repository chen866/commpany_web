...
<body>
		...
		<div id="carousel-example-generic" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="${pageContext.request.contextPath}/index/img/Shanghai.jpg"
						alt="1 slide">
				...
				<div class="item">
					<img src="${pageContext.request.contextPath}/index/img/Newyork.jpg" alt="2 slide">
					<div class="carousel-caption">
						<h1>科技+平台+服务</h1>
						<h1>全面打造资产证券化生态圈</h1>
					</div>
				...
				<div class="item">
					<img src="${pageContext.request.contextPath}/index/img/Tokyo.jpg"
						alt="3 slide">
					<div class="carousel-caption">
						<h1>安全+合规+高效</h1>
						<h1>专业服务基金行政管理</h1>
				...
				<div class="item">
					<img
						src="${pageContext.request.contextPath}/index/img/landscape.jpg"
						alt="4 slide">
					<div class="carousel-caption">
						<h1>发行+投资+咨询</h1>
						<h1>多维开展创新金融业务</h1>
		...
		<div class="feature-content">
			<div class="feature-image"">
				<a href="product.html"><img
					src="${pageContext.request.contextPath}/index/img/project-image.png"
					alt="和逸教育"></a>
			</div>
			<div class="feature-text">
				<div class="feature-text-top">
					<span class="feature-icon-project"></span> <a class="feature-title">和逸教育</a>
				</div>
		...
		<div class="feature-content">
			<div class="feature-image"">
				<a href="product-2.html"><img
					src="${pageContext.request.contextPath}/index/img/team-image.png"
					alt="和逸科技"></a>
			</div>
			<div class="feature-text">
				<div class="feature-text-top">
					<span class="feature-icon-team"></span> <a class="feature-title">和逸科技</a>
				</div>
	...
	<div class="feature clearfix">
		<div class="feature-content">
			<div class="feature-image"">
				<a href="product-3.html"><img
					src="${pageContext.request.contextPath}/index/img/dev-image.png"
					alt="和逸金服"></a>
			</div>
			<div class="feature-text">
				<div class="feature-text-top">
					<span class="feature-icon-dev"></span> <a class="feature-title">和逸金服</a>
				</div>
		...
		<div class="feature-content">
			<div class="feature-image"">
				<a href="product-3.html"><img
					src="${pageContext.request.contextPath}/index/img/job-image.png"
					alt="和逸金融"></a>
			</div>
			<div class="feature-text">
				<div class="feature-text-top">
					<span class="feature-icon-job"></span> <a class="feature-title">和逸金融</a>
				</div>
