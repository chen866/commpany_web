!function (t, e) {
    ...
    return function (t) {
        ...
        (function () {
            ...
            function a(t, e) {
                var n = P.length, r = t.constructor, i = O.isFunction(r) && r.prototype || h, s = "constructor";
            ...
            var u = this, c = u._, l = Array.prototype, h = Object.prototype, f = Function.prototype, d = l.push,
                p = l.slice, _ = h.toString, v = h.hasOwnProperty, m = Array.isArray, y = Object.keys, g = f.bind,
            ...
            }, C = Math.pow(2, 53) - 1, j = N("length"), x = function (t) {
                var e = j(t);
        ...
        "use strict";
        var r = n(50), i = n(0), s = i.extend, o = n(1), a = n(4), u = n(5), c = n(3), l = c.getSessionToken,
            h = c.ajax, f = function (t, e) {
                var n = (new Date).getTime(), i = r(n + t);
                ...
                var e = t.service, n = t.version, r = t.method, i = t.path, s = t.query, o = t.data,
                    a = void 0 === o ? {} : o, c = t.authOptions, l = t.signKey, f = void 0 === l || l;
                ...
                return p(c, f).then(function (t) {
                    return h({method: r, url: d, query: s, data: a, headers: t}).catch(v)
                })
            }, y = function (t, e, n, r) {
        ...
        }, s = n(0), o = n(7), a = n(6)("leancloud:request"), u = n(1), c = 0, l = function (t) {
            var e = t.method, n = t.url, r = t.query, s = t.data, l = t.headers, h = void 0 === l ? {} : l,
                f = t.onprogress, d = c++;
            a("request(" + d + ")", e, n, r, s, h);
            var p = {};
            if (r) for (var _ in r) "object" === i(r[_]) ? p[_] = JSON.stringify(r[_]) : p[_] = r[_];
        ...
        "use strict";
        (function (e) {
            var r = n(0), i = n(37), s = n(3), o = s.inherits, a = s.parseDate, u = e.AV || {};
            u._config = {
                serverURLs: {},
                useMasterKey: !1,
                production: null,
                realtime: null
            }, u._sharedConfig = {userAgent: i, liveQueryRealtime: null}, u._getAVPath = function (t) {
            ...
            u._installationId = null, u._getInstallationId = function () {
                ...
                if ("GeoPoint" === t.__type) return new u.GeoPoint({latitude: t.latitude, longitude: t.longitude});
                ...
                if ("File" === t.__type) {
                    var l = new u.File(t.name), h = r.clone(t);
        ...
        var d = n(43), p = n(53), _ = n(8), v = n(52), m = n(54), y = n(55), g = e = t.exports = function (t, n) {
        ...
        "use strict";
        var r = n(0), i = n(1), s = n(41), o = ["getItem", "setItem", "removeItem", "clear"];
        ...
        "use strict";
        var r = n(0), i = n(2), s = i._request, o = n(5);
        ...
        "use strict";
        var r = n(0), i = n(38), s = n(39), o = n(40), a = n(4), u = n(2)._request, c = n(1), l = n(3), h = l.tap,
            f = l.transformFetchOptions, d = n(6)("leancloud:file"), p = n(42);
        t.exports = function (t) {
            var e = function () {
                return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1)
            }, n = function (t) {
            ...
            t.File = function (e, i, s) {
                ...
                r.isArray(i) && (this.attributes.metaData.size = i.length, i = {base64: _(i)}), this._extName = "", this._data = i, "undefined" != typeof Blob && i instanceof Blob && (i.size && (this.attributes.metaData.size = i.size), i.name && (this._extName = n(i.name)));
                var o = void 0;
                ...
                className: "_File", _toFullJSON: function (e) {
                    ...
                    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "fileTokens",
                        i = this.attributes.name, s = n(i);
                    !s && this._extName && (i += this._extName, s = this._extName);
                    var o = e() + e() + e() + e() + e() + s,
                        a = {key: o, name: i, ACL: this._acl, mime_type: t, metaData: this.attributes.metaData};
        ...
        i.init = function (t) {
            ...
            var e = t.appId, n = t.appKey, o = t.masterKey, a = (t.hookKey, t.region), u = void 0 === a ? "cn" : a,
                h = t.serverURLs, d = t.disableCurrentUser, p = t.production, _ = t.realtime;
        ...
        "use strict";
        var r = n(0), i = n(4), s = n(2), o = s.request;
        t.exports = function (t) {
        ...
        "use strict";
        var r = n(47), i = n(1), s = n(3), o = s.inherits, a = n(2), u = a.request;
        t.exports = function (t) {
            t.LiveQuery = o(r, {
                constructor: function (t, e) {
                    ...
                    e.forEach(function (e) {
                        var r = e.op, i = e.object, s = e.query_id, o = e.updatedKeys;
                        if (s === n.id) {
                            var a = t.parseJSON(Object.assign({__type: "_File" === i.className ? "File" : "Object"}, i));
                ...
                init: function (e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = n.subscriptionId,
                    ...
                    var o = e.toJSON(), a = o.where, c = o.keys, l = o.returnACL;
                    return i.resolve(s).then(function (n) {
                        return u({
                            method: "POST",
                            path: "/LiveQuery/subscribe",
                            data: {query: {where: a, keys: c, returnACL: l, className: e.className}, id: n}
                        }).then(function (e) {
                            var r = e.query_id;
        ...
        var i = n(0), s = n(4), o = n(2), a = o._request, u = n(3), c = u.isNullOrUndefined, l = u.ensureArray,
            h = u.transformFetchOptions, f = ["objectId", "createdAt", "updatedAt"], d = function (t) {
        ...
        t.exports = function (t) {
            t.Object = function (e, n) {
                ...
                s && (e = i.extend({}, s, e)), n && n.collection && (this.collection = n.collection), this._serverData = {}, this._opSetQueue = [{}], this._flags = {}, this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = i.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, this.set(e, {silent: !0}), this.changed = {}, this._silent = {}, this._pending = {}, this._hasData = !0, this._previousAttributes = i.clone(this.attributes), this.initialize.apply(this, arguments)
                ...
                _fetchWhenSave: !1, initialize: function () {
                    ...
                    return t.Object._findUnsavedChildren(h.attributes, f, d), f.length + d.length > 0 ? t.Object._deepSaveAsync(this.attributes, h, u).then(function () {
                        ...
                        var t = h.id ? "PUT" : "POST", e = h._getSaveJSON(), n = {};
                        ...
                        var d = u._makeRequest || a, p = d(c, f, h.id, t, e, u, n);
                        ...
                        var o = t.Promise.resolve(i.map(e, function (e) {
                            ...
                            return a("batch", null, null, "POST", {
                                requests: i.map(e, function (t) {
                                    ...
                                    i.extend(e, t._flags);
                                    var n = "POST", r = "/1.1/classes/" + t.className;
        ...
        "use strict";
        var r = n(0), i = n(6)("leancloud:query"), s = n(1), o = n(4), a = n(2), u = a._request, c = n(3),
            l = c.ensureArray, h = c.transformFetchOptions, f = function (t, e) {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, i = n(0), s = n(2)._request, o = n(3), a = o.getSessionToken;
        t.exports = function (t) {
            var e = function () {
        ...
        "use strict";
        var r = n(0), i = n(4), s = n(2)._request, o = n(1), a = function () {
        ...
        t.exports = function (t) {
            t.User = t.Object.extend("_User", {
                _isCurrentUser: !1, _mergeMagicFields: function (e) {
                    ...
                    return s(r, null, null, "PUT", {old_password: t, new_password: e}, n)
                }, isCurrent: function () {
                ...
                resetPasswordBySmsCode: function (t, e) {
                    return s("resetPasswordBySmsCode", null, t, "PUT", {password: e})
                },
 ...
 */
        ...
        "use strict";
        var r = n(12), i = ["Browser"].concat(n(36));
        t.exports = "LeanCloud-JS-SDK/" + r + " (" + i.join("; ") + ")"
    }, function (t, e, n) {
        "use strict";
        var r = n(7), i = n(6)("cos"), s = n(1);
        ...
        "use strict";
        var r = n(7), i = n(1), s = function (t, e) {
        ...
        "use strict";
        (function (e) {
            var r = n(0), i = (n(1), {}), s = ["getItem", "setItem", "removeItem", "clear"], o = e.localStorage;
            try {
                var a = "__storejs__";
 ...
 */
            !function (e, n) {
                ...
                var J = F, B = 0, Q = void 0, V = void 0, W = function (t, e) {
                    ...
                    X = new Array(1e3), Y = void 0;
                Y = H ? function () {
                    return function () {
                        return process.nextTick(u)
                    }
                }() : z ? function () {
                    var t = 0, e = new z(u), n = document.createTextNode("");
                ...
                var Z = Math.random().toString(36).substring(16), tt = void 0, et = 1, nt = 2, rt = new E, it = new E,
                    st = 0;
 ...
 */
        ...
        !function () {
            var e = n(44), r = n(13).utf8, i = n(48), s = n(13).bin, o = function (t, n) {
