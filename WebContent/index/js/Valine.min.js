...
*/
        ...
        r.prototype.init = function (e) {
            ...
            var t = this;
            try {
                var n = e.lang, r = e.langMode, i = e.avatar, a = e.avatarForce, l = e.avatar_cdn, c = e.notify,
                    d = e.verify, p = e.visitor, x = e.pageSize, w = e.recordIP, _ = m.ds,
                ...
                var E = e.app_id || e.appId, C = e.app_key || e.appKey;
                if (!E || !C) throw 99;
                ...
                var z = e.el || null, R = u.findAll(document, z);
                ...
                var I = u.create("div", "class", "vloading"), P = u.find(t.el, ".vlist");
                t.loading = {
                    show: function (e) {
